      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="card card-body" style="padding: 20px 70px;">
            <h4>Galeria de Planta</h4>
            <hr>
            <form id="form-cadReferencia" method="post" action="php/planta_image.php" enctype="multipart/form-data">
              <label>Selecione uma Planta</label>
              <div class="form-group">
                <div class="input-group">
                  <div class="input-group">                
                    <select class="form-control" id="sel1" name="id_plan">
            ...
            <div class="row">
              <?php
                require_once("php/planta_image_galery.php");
              ?>
            </div>
          </div>
        </div>
