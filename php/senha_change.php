<?php 
  ...
  echo '<div class="row">';
        echo '<div class="form-group col-md-6">';
            echo '<label for="cad-senha">Informe a nova senha</label>'; 
            echo '<input type="password" class="form-control" id="cad_senha" name="senhausuario" required >';
        echo '</div>';
        echo '<div class="form-group col-md-6">';
            echo '<label for="cad-senha_confirma">Confirme a nova senha</label>'; 
            echo '<input type="password" class="form-control" id="cad_senha_confirma" name="senha_confirma" required>';
        echo '</div>';        
    echo '</div>';
