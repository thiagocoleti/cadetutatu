      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="card card-body" style="padding: 20px 70px;">
            ...
            <hr>
            <form id="form-cadReferencia" method="post" action="php/invertebrado_reference.php">
              ...
              <div class="form-group">
                <div class="input-group"> 
                  <select class="form-control" id="sel1" name="id_inv"> 
                    <option> </option>                
                    <?php
                      require_once("php/invertebrado_combobox.php");
                    ?>
                  </select>
                </div>
              </div>
            ...
            <div class="container">
               <table class="table table-striped">
                      ...
                      <tbody>
                        <?php
                          require_once("php/invertebrado_reference_list.php");
                        ?>
                      </tbody>
                    </table>
            </div>
