...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <ul class="navbar-nav ml-auto">
        ...
        <h4>Alterar Senha de Usuário</h4>
        <hr>
        <form method="post" action="php/usuarios.php" id="form-altSenha">
          <input type="hidden" id="acao" name="acao" value="SENHA">
            <?php
                include "php/senha_change.php";
            ?>
          <hr>
 ...
 <!-- Logout Modal-->
  ...
  <script>
    ...
    var password = document.getElementById("cad_senha")
      , confirm_password = document.getElementById("cad_senha_confirma");

    function validatePassword(){
      if(password.value != confirm_password.value) {
        confirm_password.setCustomValidity("Senhas informadas não conferem!!!");
      } else {
